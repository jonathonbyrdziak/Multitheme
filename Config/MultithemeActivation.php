 ...
 */
	public function onActivation(&$controller) {
		...
		$controller->Croogo->addAco('Multitheme/Multirules/admin_index'); // ExampleController::admin_index()
		$controller->Croogo->addAco('Multitheme/Multirules/admin_view');
		$controller->Croogo->addAco('Multitheme/Multirules/admin_edit');
		$controller->Croogo->addAco('Multitheme/Multirules/admin_add');
		$controller->Croogo->addAco('Multitheme/Multirules/admin_delete');

		//$controller->Croogo->addAco('Multitheme/Example/index', array('registered', 'public')); // ExampleController::index()
 ...
 */
	public function onDeactivation(&$controller) {
		...
		$controller->Croogo->removeAco('Multitheme'); // ExampleController ACO and it's actions will be removed
